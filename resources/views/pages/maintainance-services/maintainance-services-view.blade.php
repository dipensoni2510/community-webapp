...
@section('title', 'Maintainance Service List Page')
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <a href="maintainance-services/create" class="btn btn-primary">Add Service</a>
        </div>
        <div class="card-content">
          <div class="card-body card-dashboard">
            <div class="table-responsive">
              <table id="serviceTable" class="table zero-configuration data-table">
                <thead>
                  <tr>
                    <th>ID</th>
                    <th>Title</th>
...
<script type="text/javascript">
  ...
  $(document).on('click', '.button-remove-service', function(e) {
    e.preventDefault();
    let id = $(this).data('id');
        ...
        $.ajax({
          ...
          success: function(response) {
            Swal.fire({
              type: "success",
              title: 'Removed!',
              text: 'Maintainance Service Removed.',
