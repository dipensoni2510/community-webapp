...
@section('title', 'Maintainance Provider List Page')
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <a href="maintainance-providers/create" class="btn btn-primary">Add Service Provider</a>
        </div>
        <div class="card-content">
          <div class="card-body card-dashboard">
            <div class="table-responsive">
              <table id="serviceProviderTable" class="table zero-configuration data-table">
                <thead>
                  <tr>
                    <th>ID</th>
...
<script type="text/javascript">
  $('#serviceProviderTable').DataTable({
    ...
    ajax: "{{route('maintainance-providers')}}",
    columns: [{
        data: 'id'
      },
      {
  ...
  $(document).on('click', '.button-remove-service-provider', function(e) {
    e.preventDefault();
    let id = $(this).data('id');
        ...
        $.ajax({
          ...
          success: function(response) {
            Swal.fire({
              type: "success",
              title: 'Removed!',
              text: 'Maintainance Provider Removed.',
