                              ...
                              @method('PUT')
                                ...
                                <div class="form-label-group">
                                  ...
                                  value="{{ $announcement->type }}">
                                      ...
                                      <option value="maintainance" {{ $announcement->type === "maintainance" ? 'selected' : '' }}>
                                        Maintainance    
                                      </option>
                                      <option value="event" {{ $announcement->type === "event" ? 'selected' : '' }}>
                                        Event    
                                      </option>     
                                  </select>
                                  @error('type')
                                ...
                                <div class="form-label-group">
                                    <textarea id="description" type="text" class="form-control @error('description') is-invalid @enderror" name="description" placeholder="Description" value="{{ $announcement->description }}"  autocomplete="description">{{ $announcement->description }}</textarea>
                                ...
                                <div class="form-label-group">
                                  ...
                                  name="date" placeholder="Start Date" value="{{ $announcement->date }}" />
                                ...
                                <div class="form-label-group mt-1">
                                  <!-- <input type="text" id="inputName" class="form-control" placeholder="Name" required> -->
                                  <input type='text' class="form-control pickatime timepicker @error('time') is-invalid @enderror" name="time" id="time" placeholder="Select Time" value="{{ $announcement->time }}" step="1" />
                                ...
                                <div class="form-label-group mt-1 mb-0">
                                  <!-- <input type="text" id="inputName" class="form-control" placeholder="Name" required> -->
                                  <input type='number' class="form-control @error('days') is-invalid @enderror" name="days" max="365" id="days" placeholder="Days" value="{{ $announcement->days }}" />
