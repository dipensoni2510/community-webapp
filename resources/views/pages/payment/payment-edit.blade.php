                    ...
                    <div class="card rounded-0 mb-0 p-2">
                        ...
                        <div class="card-content">
                            <div class="card-body pt-0 pb-0 pr-0 pl-0">
                                <form method="POST" action="{{url('/payments/'.$payment->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-label-group">
                                      <select class="custom-select form-control @error('user_id') is-invalid @enderror" name="user_id" value="{{ $payment->user_id }}">
                                          <option value="">Select Tenant</option>
                                          @foreach ($tenants as $tenant)
                                          <option value="{{ $tenant->id }}" {{ $payment->user_id == $tenant->id ? 'selected' : '' }}>
                                  ...
                                  <div class="form-label-group">
                                    ...
                                    name="start_date" placeholder="Start Date" value="{{ $payment->start_date }}" />
                                ...
                                <div class="form-label-group">
                                  ...
                                  name="end_date" placeholder="End Date" value="{{ $payment->end_date }}" />
                                  ...
                                  @error('end_date')
                                    ...
                                    <div class="form-label-group mt-1">
                                        ...
                                        <input id="monthly_rent" type="text" class="form-control @error('monthly_rent') is-invalid @enderror" name="monthly_rent" placeholder="Monthly Rent" value="{{ $payment->monthly_rent }}" autocomplete="monthly_rent">
                                    ...
                                    <div class="form-label-group">
                                        <!-- <input type="text" id="inputName" class="form-control" placeholder="Name" required> -->
                                        <input id="monthly_maintainance_rent" type="text" class="form-control @error('monthly_maintainance_rent') is-invalid @enderror" name="monthly_maintainance_rent" placeholder="Maintainance Rent" value="{{ $payment->monthly_maintainance_rent }}" autocomplete="monthly_maintainance_rent">
