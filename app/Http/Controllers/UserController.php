...
class UserController extends Controller
{
    ...
    {
        $breadcrumbs = [
            ['link' => route('home'), 'name' => "Home"], ['name' => "Tenant List"]
        ];
    ...
    {
        $breadcrumbs = [
            ['link' => route('home'), 'name' => "Home"], ['link' => "/user-dashboard", 'name' => "Tenant List"], ['name' => "View"]
        ];
    ...
    public function store(User $user)
    {
        ...
        if (request('avatar')) {
            $validate['avatar'] = request('avatar')->store('avatars');
        }
    ...
    {
        $breadcrumbs = [
            ['link' => route('home'), 'name' => "Home"], ['link' => "/user-dashboard", 'name' => "Tenant List"], ['name' => "Edit"]
        ];
    ...
    public function update(User $user)
    {
        ...
        return redirect()->route('userdashboard')->with('message', 'User Updated!');
    }
